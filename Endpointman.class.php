...
define("PHONE_MODULES_PATH", $this->PHONE_MODULES_PATH);
    ...
    public function uninstall() {
    	...
    	$sth = $this->db->prepare($sql);
    	$sth->execute();
    	$sql = "DROP TABLE IF EXISTS `endpointman_time_zones`";
    	$sth = $this->db->prepare($sql);
    	$sth->execute();
    	$sql = "DROP TABLE IF EXISTS `endpointman_time_zones_new`";
    	$sth = $this->db->prepare($sql);
    	$sth->execute();
    	$sql = "DROP TABLE IF EXISTS `endpointman_time_zones_desc`";
    	$sth = $this->db->prepare($sql);
    	$sth->execute;
